...
export const NeuroDashboard: React.FC = () => {
  ...
  // Open by default on desktop; collapsed on phones so the telemetry panel
  // doesn't blanket the chat on a narrow viewport (it floats fixed at ~320px).
    ...
    >
      ...
      <div className="pointer-events-auto flex flex-col items-end gap-2">
        ...
        <motion.div 
          ...
          className="bg-[#08080C]/90 backdrop-blur-3xl border border-white/10 rounded-3xl flex flex-col p-6 overflow-hidden shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)] max-w-[calc(100vw-3rem)]"
        >
