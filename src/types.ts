...
export type AppView = 'chat' | 'lattice' | 'vault' | 'capabilities' | 'labyrinth' | 'anomalies' | 'surprise' | 'coding-lab' | 'memory-workspace';

export type AIProvider = 'ollama' | 'openrouter' | 'gemini' | 'deepseek' | 'omniroute';
